...
#     _name = "pos.refund.importer"
#     _inherit = "pos.importer"
#     _apply_on = "pos.refund"

#     _model_name = "pos.refund"

#     def _import_dependencies(self):
#         record = self.pos_record
#         self._import_dependency(record["id_customer"], "pos.res.partner")
#         self._import_dependency(record["id_order"], "pos.sale.order")

#     def _open_refund(self, binding):
#         invoice = binding.odoo_id
#         if invoice.amount_total == (
#             float(self.pos_record["amount"])
#             + float(self.pos_record["shipping_cost_amount"])
#         ):
#             invoice.action_post()
...
#         if not journal:
#             raise MappingError(
#                 _("The refund journal must be configured on the Pos Backend.")
#             )
#         return {"journal_id": journal.id}

#     def _get_order(self, record):
#         binder = self.binder_for("pos.sale.order")
...
#     #        return {"comment": _("Pos amount: %s") % record["amount"]}
...
#         order_line = self.env["pos.sale.order.line"].search(
#             [
#                 ("pos_id", "=", order_details_id),
...
#     _name = "pos.refund.batch.importer"
